...
var CFG = (function() {
     var cfg = {
        ...
        getRemainAwards: '//61.191.24.229:5021/autumn/activity/getlotterynum', // 获取抽奖次数
        getChoujiangUrl: '//61.191.24.229:5021/autumn/activity/sweepstake', // 获取是否中奖
        getSaveAddressUrl: '//61.191.24.229:5021/lxactserver/activity/recordwinnerinfo', // 填写中奖用户信息
        getAddChanceUrl: '//61.191.24.229:5021/autumn/activity/addchance', // 分享增加机会
        
        amid: 'AM005232', // 咪咕汇活动id
